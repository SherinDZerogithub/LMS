...
const Player = () => {
  ...
  // Fetch course data when component mounts or courseId/enrolledCourses changes
  useEffect(() => {
    getCourseData();
  }, [enrolledCourses, courseId]); // Add dependencies to prevent infinite re-renders

  return (
    <>
      <div className=" flex flex-col-reverse md:grid md:grid-cols-2 gap-10 p-3  sm:p-10 ">
        {/* Left Column */}
        <div className="text-gray-800 text-left">
          ...
          <div className="flex items-center gap-2 pt-3 mt-10">
